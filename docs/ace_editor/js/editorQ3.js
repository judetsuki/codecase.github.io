...
var item = JSON.parse(localStorage.getItem('dataToPass3')); //заменить на нужную задачу
// Setup Ace
let codeEditor = ace.edit("editorCode");
let defaultCode = item.FuncNameQ3; // добавить имена функций в зависимости от задачи
let consoleMessages = [];
...
editorLib.init();
    //console.log(codeEditor.getValue()); беру значение из редактора
        ...
        submitCodeBtn.addEventListener('click', () => {
            ...
            const userFunction = new Function([item.FuncArgsQ3], removeFirstAndLastBrackets(userCode));
