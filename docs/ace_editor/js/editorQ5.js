...
var item = JSON.parse(localStorage.getItem('dataToPass5')); //заменить на нужную задачу
// Setup Ace
let codeEditor = ace.edit("editorCode");
let defaultCode = item.FuncNameQ5; // добавить имена функций в зависимости от задачи
let consoleMessages = [];
...
editorLib.init();
    //console.log(codeEditor.getValue()); беру значение из редактора
        ...
        submitCodeBtn.addEventListener('click', () => {
            ...
            const userFunction = new Function([item.FuncArgsQ5], removeFirstAndLastBrackets(userCode));
        ...
        item.testsQ5.forEach(testCase => {
            ...
            let solvedItemsLS = localStorage.getItem('solvedItem5') || [];
