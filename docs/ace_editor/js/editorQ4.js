...
var item = JSON.parse(localStorage.getItem('dataToPass4')); //заменить на нужную задачу
// Setup Ace
let codeEditor = ace.edit("editorCode");
let defaultCode = item.FuncNameQ4; // добавить имена функций в зависимости от задачи
let consoleMessages = [];
...
editorLib.init();
    //console.log(codeEditor.getValue()); беру значение из редактора
        ...
        submitCodeBtn.addEventListener('click', () => {
            ...
            const userFunction = new Function([item.FuncArgsQ4], removeFirstAndLastBrackets(userCode));
        ...
        item.testsQ4.forEach(testCase => {
            ...
            let solvedItemsLS = JSON.parse(localStorage.getItem('solvedItem4')) || [];
            ...
            if (correctCount === 3) {
                ...
                item.taskCodeQ4 = userCode;
                solvedItemsLS.push(item);
                localStorage.setItem('solvedItem4', JSON.stringify(solvedItemsLS));
            });
            } else {
