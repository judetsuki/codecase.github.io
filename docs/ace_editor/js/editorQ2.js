...
editorLib.init();
    //console.log(codeEditor.getValue()); беру значение из редактора
        ...
        submitCodeBtn.addEventListener('click', () => {
            ...
            const userFunction = new Function([item.FuncArgsQ2], removeFirstAndLastBrackets(userCode));
        ...
        item.testsQ2.forEach(testCase => {
            ...
            let solvedItemsLS = JSON.parse(localStorage.getItem('solvedItem2')) || [];
            ...
            if (correctCount === 3) {
                ...
                item.taskCodeQ2 = userCode;
                solvedItemsLS.push(item);
                localStorage.setItem('solvedItem2', JSON.stringify(solvedItemsLS));
            });
            } else {
